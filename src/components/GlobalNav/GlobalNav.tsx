...
interface NavItem {
  path: string;
  label: string;
  icon: 'home' | 'circle-user' | 'user-group' | 'calendar-clock' | 'id-badge' | 'chart-pie-simple' | 'file-lines' | 'circle-dollar';
}
...
const navItems: NavItem[] = [
  ...
  { path: '/time-attendance', label: 'Time & Attendance', icon: 'calendar-clock' },
